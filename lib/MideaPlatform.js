...
class MideaPlatform {
    ...
    updateValues() {
        ...
        let data = ac_header.concat(Constants_1.default.UpdateCommand);
            ...
            if (mideaAccessory === undefined) {
                ...
                try {
                    ...
                    if (mideaAccessory.deviceType == MideaDeviceType_1.MideaDeviceType.AirConditioner) {
                        data = ac_header.concat(Constants_1.default.UpdateCommand);
                        ...
                        data = dh_header.concat(Constants_1.default.UpdateCommand_Dehumidifier);
                        const response = await this.sendCommand(mideaAccessory, data);
