                        ...
                        body.result.list.forEach(async (currentElement) => {
                            if (parseInt(currentElement.type) == MideaDeviceType_1.MideaDeviceType.AirConditioner || parseInt(currentElement.type) == MideaDeviceType_1.MideaDeviceType.Dehumidifier) {
                                ...
                                if (existingAccessory) {
                                    ...
                                    var ma = new MideaAccessory_1.MideaAccessory(this, existingAccessory, currentElement.id, parseInt(currentElement.type), currentElement.name);
                                    ...
                                    var ma = new MideaAccessory_1.MideaAccessory(this, accessory, currentElement.id, parseInt(currentElement.type), currentElement.name);
            ...
            return new Promise((resolve, reject) => {
                ...
                request.post({
                    ...
                    try {
                        ...
                        this.log.debug('Full data is', Utils_1.default.formatResponse(response.data));
                        resolve();
                    }
                    catch (error) {
                        this.log.debug(body);
