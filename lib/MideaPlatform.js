...
class MideaPlatform {
    ...
    constructor(log, config, api) {
        ...
        this.baseHeader = { 'User-Agent': Constants_1.default.UserAgent, 'Content-Type': 'application/x-www-form-urlencoded' };
        this.axiosConfig = {
    ...
    login() {
        return new Promise((resolve, reject) => {
            ...
            axios.post(url, qs.stringify(form), this.axiosConfig).then((response) => {
    ...
    getFirmwareVersionOfDevice(device) {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post(url, qs.stringify(form, { encode: false }), this.axiosConfig).then((response) => {
                this.log.debug(response);
