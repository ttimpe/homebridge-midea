...
class MideaAccessory {
    ...
    handleTargetHeaterCoolerStateSet(value, callback) {
        ...
        if (value != MideaOperationalMode_1.MideaOperationalMode.Off) {
            if (value == MideaOperationalMode_1.MideaOperationalMode.Cooling) {
                value = this.platform.Characteristic.TargetHeaterCoolerState.COOL;
            }
            else if (value == MideaOperationalMode_1.MideaOperationalMode.Heating) {
